...
<div class="container col-12" style="background-color: white; z-index: -2;"><br>
      <h5 class='dondeyCuando col-12 col-lg-12 text-center text-dark mt-5 mb-0' >Confirmar asistencia</h5> 
      <div class="text-center "> 
        <img class="text-center col-11 col-lg-3 mt-0 mb-4" src="../img/bodasimg/demo002/ornamenta.svg" > 
    </div>
